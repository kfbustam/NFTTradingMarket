...
const GET_TRANSACTIONS = process.env.REACT_APP_API_URL + "/user_nft_listings?token="
                                 ...
                                 apiResponse.map((item,index) =>(
                                    <div className="sc-card-activity style1" key={index}>
                                        <div className="content">
                                            <div className="media">
                                                <img src={process.env.REACT_APP_API_URL + "/images?image_name=" + item.imageURL} alt="Axies" />
                                            </div>
                                            <div className="infor">
